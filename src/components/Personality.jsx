...
export default function Personality() {
    return (
      <main className="flex bg-[#E8F0F3] flex-col justify-center items-center mx-auto w-full max-w-[470px] text-center gap-8">
      ...
      <div className="flex justify-center gap-6 px-2 sm:px-4">
        ...
        <div className="flex flex-col items-center justify-center relative">
          ...
          <img
            src={profilebtn}
            alt="Profile Button"
            className="w-[150px] h-[48px] object-contain mt-2"
          />
        </div>
      </div>
          </section>
